...
\newcommand{\mybookauthor}{Pablo Acereda García}
...
\newcommand{\mybookNameFirstAdvisor}{Daniel Rodríguez García}
...
\newcommand{\mybookpalabrasclave}{Data Mining, Desbalanceo, Métricas de Complejidad, Under Sampling, Over Sampling} % (máximo de cinco)
...
% Not required if you 
\newcommand{\mystreet}{C/ Pino Puente, 12, 2ºB}
\newcommand{\mycity}{Alcalá de Henares}

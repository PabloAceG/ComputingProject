...
It could also happen that the number of minority class samples are not only low,
but that some folds might not get enough samples of that class - could be solved
by increasing the number of samples collected for a certain dataset, or 
redistributing the minority class through the folds. This would also explain
why imbalance techniques are not able to improve the performance of the 
classifiers
